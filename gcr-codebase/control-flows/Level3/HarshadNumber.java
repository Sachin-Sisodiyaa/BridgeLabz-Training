...
public class HarshadNumber
{
	public static void main(String[] args)
	{
		...
		// Cheking  number is harshad or not
		while(number > 0){
			int digit = number % 10;		
			sum += digit;
			number /= 10;
		...
		//Printing result based on condition
		if(originalNumber % sum == 0){
			System.out.print("The Number " + originalNumber + " is a Harshad Number ");
		}
		else {
			System.out.print("The Number " + originalNumber + " is not a Harshad Number ");
		}
		input.close();
