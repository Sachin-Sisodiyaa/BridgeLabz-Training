package com.daytwo.dealtracker;
...
public class DealTrackerDemo {
    ...
    private static final String DEFAULT_DEAL_FOLDER = 
        "C:\\GitProjects\\Java programming workspace\\java-collections-practice\\scenario-based\\scenarioBased\\src\\com\\daytwo\\dealtracker";
    ...
    public static void main(String[] args) {
        ...
        while (choice != 0) {
            System.out.println("\nSelect an option:");
            System.out.println("1️ Load Deals from Default Folder");
            System.out.println("2️ Display All Valid Deals");
            System.out.println("3️ Display Deals Sorted by Discount");
