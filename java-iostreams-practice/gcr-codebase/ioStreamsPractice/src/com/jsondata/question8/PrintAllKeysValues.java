...
public class PrintAllKeysValues {
    ...
    public static void main(String[] args) {
        try {
            ...
            // 1️⃣ Read JSON file
            File file = new File("C:\\GitProjects\\Java programming workspace\\java-iostreams-practice\\gcr-codebase\\ioStreamsPractice\\src\\com\\jsondata\\question8\\student_list.json");
