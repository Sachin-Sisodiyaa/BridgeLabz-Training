...
public class ListToJSONArray {
    public static void main(String[] args) {
        try {
            ...
            students.add(new Student("Sachin Sisodiya", 21, "sachin@example.com", Arrays.asList("Math", "Physics")));
            ...
            File file = new File("C:\\GitProjects\\Java programming workspace\\java-iostreams-practice\\gcr-codebase\\ioStreamsPractice\\src\\com\\jsondata\\question6\\students_list.json");
