...
public class MergeStudentJSON {
    public static void main(String[] args) {
        try {
            ...
            String student1Part1 = "{ \"name\": \"Rishi Sharma\", \"age\": 21 }";
            String student1Part2 = "{ \"email\": \"rishi@example.com\", \"subjects\": [\"Math\", \"Physics\"] }";
            ...
            File file = new File("C:\\GitProjects\\Java programming workspace\\java-iostreams-practice\\gcr-codebase\\ioStreamsPractice\\src\\com\\jsondata\\question4\\students_merged.json");
