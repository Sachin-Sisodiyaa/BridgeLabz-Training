...
public class ExtractSpecificFields {
    public static void main(String[] args) {
        try {
            ...
            // 2️⃣ Read JSON file
            File file = new File("C:\\GitProjects\\Java programming workspace\\java-iostreams-practice\\gcr-codebase\\ioStreamsPractice\\src\\com\\jsondata\\question3\\students.json");
