...
public class ValidateJSON {
    public static void main(String[] args) {
        ...
        File jsonFile = new File("C:\\GitProjects\\Java programming workspace\\java-iostreams-practice\\gcr-codebase\\ioStreamsPractice\\src\\com\\jsondata\\question5\\students_merged.json");
