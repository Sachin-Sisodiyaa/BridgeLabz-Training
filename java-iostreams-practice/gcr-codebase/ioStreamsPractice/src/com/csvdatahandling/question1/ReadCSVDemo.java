...
public class ReadCSVDemo {
    ...
    public static void main(String[] args) {
        ...
        String csvFile = "C:\\GitProjects\\Java programming workspace\\java-iostreams-practice\\gcr-codebase\\ioStreamsPractice\\src\\com\\csvdatahandling\\question1\\studentduplicate.csv"; // Make sure this file exists in your project folder
        String line = "";
        String splitBy = ",";
