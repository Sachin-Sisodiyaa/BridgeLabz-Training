...
public class MergeTwoCSV {
    ...
    public static void main(String[] args) {
        ...
        String file1 = "C:\\GitProjects\\Java programming workspace\\java-iostreams-practice\\gcr-codebase\\ioStreamsPractice\\src\\com\\csvdatahandling\\question10\\students1.csv";

        String file2 = "C:\\GitProjects\\Java programming workspace\\java-iostreams-practice\\gcr-codebase\\ioStreamsPractice\\src\\com\\csvdatahandling\\question10\\students2.csv";

        String outputFile = "C:\\GitProjects\\Java programming workspace\\java-iostreams-practice\\gcr-codebase\\ioStreamsPractice\\src\\com\\csvdatahandling\\question10\\merged_students.csv";
        ...
        try (BufferedReader br = new BufferedReader(new FileReader(file1))) {
            ...
            while ((line = br.readLine()) != null) {
                ...
                if (parts.length != 3) {
                    System.out.println("Skipping invalid row in students1: " + line);
                    continue;
                }
        ...
        try (BufferedReader br = new BufferedReader(new FileReader(file2))) {
            ...
            while ((line = br.readLine()) != null) {
                ...
                if (parts.length != 3) {
                    System.out.println("Skipping invalid row in students2: " + line);
                    continue;
                }
                ...
                if (basicInfoMap.containsKey(id)) {
                    ...
                    System.out.println("No matching ID in students1 for ID: " + id);
                }
            }
