...
public class EventTrackerApp {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("EventTracker – Auto Audit System");
        System.out.println("=================================");

        List<AuditEvent> events =
                AuditScanner.scan(UserActionService.class);

        JsonLogger.writeLogs(events, "C:\\GitProjects\\Java programming workspace\\java-iostreams-practice\\scenario-based\\scenarioBased\\src\\com\\day1\\eventtracker\\audit_log.json");
    }
}
